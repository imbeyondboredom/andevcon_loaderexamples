...
public class ActivityProgressLoader extends FragmentActivity {
    ...
    private static class ProgressLoader extends ExecutorServiceLoader<Void> {
        ...
        @Override
        protected ResultOrException<Void, Exception> loadInBackground() {
            state = State.LOADING;
            current = 0;
            total = ITERATIONS;
            ...
            return new ResultOrException<Void, Exception>((Void) null);
        }
